...
@section('content')
    <div class="d-flex justify-content-between align-items-center my-3">
        <h1>Reviews</h1>
        <a href="{{ route('reviews.create') }}" class="btn btn-secondary">Create New</a>
    </div>
    ...
    <table class="table">
        <thead>
            <tr>
                <th scope="col">#</th>
                <th scope="col">Review Created At</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $review->cake->name }}</td>
                <td>
                    <div class="d-flex gap-3">
                        <a href="{{ route('reviews.show', $review) }}" class="btn btn-primary">See More</a>
